...
<html>
  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
    ...
    <div class="container">
        ...
        <form method="POST" action="addNewProduct" enctype="multipart/form-data" name="addfood" id="addfood" onsubmit="return validateForm()">
            ...
            <td> <TEXTAREA name="description" id="description"COLS=60 ROWS=8></TEXTAREA></td>
                 </tr>
               <tr>
            <td> Cost: </td>
